 ...
 * @author User
 */
public class JavaIII extends javax.swing.JFrame {

    /**
     * Creates new form JavaIII
     */
    public JavaIII() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/imagens/Java_jdk_logo_web-372x210.jpg"))); // NOI18N
        ...
        jLabel3.setText("Dados Complementares.:");
        ...
        jButton3.setText("Desabilitar Campos");
        ...
        jButton4.setText("Habilitar Campos");
        ...
        jButton5.setText("Contar Componentes");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        for(int i=0;i< componentes.length; i++){
            if(componentes[i] instanceof JTextField){
                contaTF++;
                JTextField campoTF = (JTextField) componentes[i];
                campoTF.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaIII.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
