 ...
 * @author User
 */
public class FormServidor1 extends javax.swing.JFrame {

    /**
     * Creates new form FormServidor
     */
    public FormServidor1() {
        initComponents();       
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormServidor1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormServidor1().setVisible(true);
            }
        });
    }
